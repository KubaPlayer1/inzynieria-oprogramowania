                ...
                if(isset($_POST["submit"])){
                            ...
                            */
                            $queryBuilder = $entityManager->createQueryBuilder();
                                    ...
                                    <table>
                                        ...
                                        {               
                                            ?> <?php echo "<tr><td>". $d->getNazwa() . " </td><td>" . $d->getCpu_socket()."</td><td></td></tr>"?> <?php                              
                    ...
                    if ($podzespoly[3] == $select) 
                    {
                        ...
                        <?php if(isset($_POST['name'])) 
                        {
                            ...
                            <table>
                                ...
                                <?php
                                foreach($dane_lista as $d) {  ?> <?php echo "<tr><td>". $d->getNazwa()." </td><td>".$d->getChipset_plyty()." </td><td>".$d->getGniazdo_procesora()." </td><td>".$d->getStandard_plyty()."</td></tr>";
                    ...
                    if ($podzespoly[4] == $select) 
                    {
                        ...
                        <input type="submit" name="submit" value="Submit"/>
                            ...
                            <?php if(isset($_POST['name'])) 
                            {
                                ...
                                <?php
                                foreach($dane_lista as $d) { ?> <?php echo "<tr><td>".$d->getNazwa()." </td><td>".$d->getCzestotliwosc()." </td><td>".$d->getOpluznienie()." </td><td>".$d->getTyp_pamieci()."</td></tr>" ;
                    ...
                    if ($podzespoly[5] == $select) {
                        ...
                        <form action="add.php" method="POST">
                            ...
                            <?php
                            foreach($dane_lista as $d) {  ?> <?php echo  "<tr><td>".$d->getNazwa()." </td><td>". $d->getInterfejs()." </td><td>".$d->getPojemnosc()."</td></tr>";
                    ...
                    ?>
                        ...
                        <?php
                            foreach($dane_lista as $d) {  ?><?php echo "<tr><td>".$d->getNazwa()." </td><td>". $d->getSocket()." </td><td>". $d->getMaks_TDP()."</td></tr>";
                    ...
                    if ($podzespoly[8] == $select) {
                        ...
                        <?php if(isset($_POST['name'])) 
                        {
                            ...
                            <?php
                              foreach($dane_lista as $d) {  ?> <?php echo "<tr><td>". $d->getNazwa()." </td><td>".$d->getStandard()." </td><td>".$d->getTyp_obudowy()." </td><td>".$d->getMaks_dlugosc_karty_graf()."</td></tr>";
